...
$qry_periode = "
SELECT * FROM periode ORDER BY kd_periode DESC LIMIT 0,30
 ";
...
<div id="templatemo_main" class="wrapper">
	...
	<h2>Insentif Gaji</h2>     
	    <table class ="bordered" width="" border=0>
		<tr align="center">
		<th>kd.Periode</th>
		<th>Periode</th>
		<th> .::. </th>		
		...
		<td align="rigt"><a href="emp_insentif.php?kd_periode=<?php echo $row_periode[kd_periode];?>">::.<?php echo $row_periode[nama_periode];?></a></td>
