		...
		<form name="form1" method="POST" action="saveinsert_m_jabatan.php">
			<table width="600" class="bordered" align="center">
				<tr>
					...
					<td width="325"><input name="kd_jabatan" id="" value="<?php if ($_REQUEST['edit'] == 1) {
    echo $row_editjabatan['kd_jabatan'];
} else {
    echo $max;
}
?>"></td>
				...
				<tr>
					...
					<td><input name="nama_jabatan" type="text" id="nama_jabatan" value="<?php if ($_REQUEST['edit'] == 1) {
    echo $row_editjabatan['nama_jabatan'];
}
?>"></td>
				</tr>
				...
				<tr>
					...
					<td>&nbsp;</td>
					<td><input name="<?php if ($_REQUEST['edit'] == 1) {
    echo "btn_edit";
} else {
    echo "btn_save";
}
?>" type="submit" id="<?php if ($_REQUEST['edit'] == 1) {
    echo "btn_edit";
} else {
    echo "btn_save";
}
?>" value="<?php if ($_REQUEST['edit'] == 1) {
    echo "btn_edit";
} else {
    echo "btn_save";
}
