...
<div id="templatemo_main" class="wrapper">
	...
	<h2>Insert Insentif Uang Makan</h2>     
	    <table class="bordered">
		<tr>
		<td>EMP ID</td><td>EMP name</td><td><a href="periode_insentif_ium.php">Back</a></td>
		</tr>
		<?php while ($row_emp=mysqli_fetch_assoc($rs_emp)) { ?>
		<tr>
		<td><?php echo $row_emp['emp_id'];?></td><td><?php echo $row_emp['emp_name'];?></td>
		<td><a href="insert_insentif_ium.php?emp_id=<?php echo $row_emp['emp_id'];?>&kd_periode=<?php echo $row_periode['kd_periode'];?>">Next</a></td>
		</tr>
		<?php } ?>
		</table>		 
