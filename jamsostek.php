...
$rs_periode = mysqli_query($link, $qry_periode);
$row_periode=mysqli_fetch_assoc($rs_periode);

$qry_emp = "SELECT b.emp_id, b.emp_name, a.kd_periode
FROM jamsostek a, employee b
...
<div id="templatemo_main" class="wrapper">
	<!-- Tempat Menaruh Tabel ISI -->
	    <h2>Group Periode <?php echo "No ($row_periode[kd_periode]) $row_periode[nama_periode]";?></h2>        		
		<!-- Awal tabel -->
		...
		<a href="insert_jamsostek.php?kd_periode=<?php echo $_REQUEST['kd_periode'];?>" >Insert</a> | 
		<a href="saveinsert_jamsostek.php?del_all=1&kd_periode=<?php echo $_REQUEST['kd_periode'];?>" >Delete all</a> |
