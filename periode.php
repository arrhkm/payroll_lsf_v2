...
<div id="templatemo_main" class="wrapper">
	<!-- Tempat Menaruh Tabel ISI -->
		...
		$Emp->setEmp(
                    ...
                    //$row_emp['t_masakerja'], //6
                    $row_emp['nama_jabatan'], //7
                    $row_emp['no_rekening'], //8
                    $row_emp['emp_group'], //9
                    $row_emp['pot_telat']//10
                );
		...
		for ($i=0;$i<=$selisih;$i++) { 
			...
			//setting durasi
			$Emp->Durasi->setTime($office_in, $office_out, $row_absensi['jam_in'], $row_absensi['jam_out'], $Emp->DayPeriode->logika_periode, $row_absensi['tgl'],$Emp->emp_id, $link);
