...
$qry_emp="
SELECT emp_id, emp_name, pot_jamsos
FROM employee 
";
...
<div id="templatemo_main" class="wrapper">	
	<!-- Tempat Menaruh Tabel ISI -->
		...
		<!-- Awal tabel -->
		<form name="form1" method="POST" action="saveinsert_jamsostek_pending.php">
		  <table width="600" class="bordered" align="">
			...
			<input type='button' value='Back' name='btn_back' class='bordered' onClick="location='jamsostek_pending.php?kd_periode=<?php echo $_REQUEST[kd_periode];?>'">
			</td>
			</tr>
			<tr>
			  <td width="325">
				<?php								
				$num_row=mysql_num_rows($rs_emp);
				$no=1;	
				while($row=mysql_fetch_array($rs_emp))
				{ ?>
				<table border=0>
				<tr>
				<td><?php echo $no;?>
