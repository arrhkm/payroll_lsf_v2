...
$qry_emp="SELECT b.emp_id, b.emp_name
FROM set_workshift a RIGHT JOIN employee b 
		  ...
		  <table width="600" class="bordered" align="">
			...
			<tr>
			  <td width="325">
				...
				$no=1;	
				while($row=mysqli_fetch_assoc($rs_emp))
				{ ?>
				<table border=0>
				<tr>
				<td><?php echo $no;?>
			...
			<td>
				...
				<input type= hidden name= "id_workshift" value="<?php echo $_REQUEST[id_workshift];?>">
			</td>
			</tr>
			<tr>
			<td>
				...
				<input type='button' value='Back' name='btn_back' class='bordered' onClick="location='m_workshift.php?id_workshift=<?php echo $_REQUEST[id_workshift];?>'">
			</td>
			</tr>
