...
$row_attribut=mysqli_fetch_assoc($qry_attribut);
		...
		$SUM_TRESIKO2 = "Rp.".number_format($SUM_TRESIKO, 2, ',', '.');
		...
		$pdf->Cell($w[9],$t_baris,$jml_kasbon2,1,0,'R');
		$pdf->Cell($w[10]+$w[11],$t_baris,'Cicilan kasbon',1,0,'L');
		$pdf->Cell($w[12],$t_baris,$jml_cicilan2,1,0,'R');
		$pdf->Ln();		
		$pdf->Cell($w[0]+$w[1]+$w[2]+$w[3]+$w[4]+$w[5]+$w[6]+$w[7],$t_baris,'',0,0,'C');
		$pdf->Cell($w[8],$t_baris,'Sisa Kasbon',1,0,'L');
		$pdf->Cell($w[9],$t_baris,$saldo2,1,0,'R');
		$pdf->Cell($w[10]+$w[11],$t_baris,'Jamsostek',1,0,'L');
		$pdf->Cell($w[12],$t_baris,$pot_jamsos2,1,0,'R');
		$pdf->Ln();				
		
		$pdf->Cell($w[0]+$w[1]+$w[2]+$w[3]+$w[4]+$w[5]+$w[6]+$w[7]+$w[8]+$w[9],$t_baris,'',0,0,'C');
		$pdf->Cell($w[10]+$w[11],$t_baris,'Kelebihan Gaji',1,0,'L');
		$pdf->Cell($w[12],$t_baris,$jml_plus2,1,0,'R');
		$pdf->Ln();
		$pdf->Cell($w[0]+$w[1]+$w[2]+$w[3]+$w[4]+$w[5]+$w[6]+$w[7]+$w[8]+$w[9],$t_baris,'',0,0,'C');
		$pdf->Cell($w[10]+$w[11],$t_baris,'Kekurangan Gaji',1,0,'L');
		$pdf->Cell($w[12],$t_baris,$jml_min2,1,0,'R');
		$pdf->Ln();	
