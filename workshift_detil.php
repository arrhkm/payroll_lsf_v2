		...
		<form name="form1" method="POST" action="save_workshift_detil.php">
		  <table width="600" class="bordered" align="center">
			...
			<tr>
			  ...
			  <td width="325"><input name="num_day"  id="num_day" value="<?php if ($_REQUEST['edit']==1) echo $row_editworkshift_detil['num_day']; else echo $max;?>"></td>
			</tr>
			<tr>
			  <td>id_workshift</td>			 
			  <td><input name="id_workshift" type="text" id="id_workshift" value="<?php if ($_REQUEST['edit']==1) echo $row_editworkshift_detil['id_workshift']; else echo $_REQUEST[id_workshift];?>"></td>
			</tr>
			<tr>
			  <td>logika</td>			 
			  <td><input name="logika" type="text" id="logika" value="<?php if ($_REQUEST['edit']==1) echo $row_editworkshift_detil['logika'];?>"></td>
			</tr>
			<tr>
			  <td>office in</td>			 
			  <td><input name="office_in" type="text" id="office_in" value="<?php if ($_REQUEST['edit']==1) echo $row_editworkshift_detil['office_in'];?>"></td>
			</tr>
			<tr>
			  <td>office_out</td>			 
			  <td><input name="office_out" type="text" id="office_out" value="<?php if ($_REQUEST['edit']==1) echo $row_editworkshift_detil['office_out'];?>"></td>
			</tr>
			<tr>			  
			  <td>&nbsp;</td>
